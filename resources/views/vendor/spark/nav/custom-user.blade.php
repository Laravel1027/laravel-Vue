            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <!-- Notifications -->
                    ...
                    <li :class="dropdown" @click="toggleDropdown">
                        <!-- User Photo / Name -->
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" :aria-expanded="show">
                            <img :src="user.photo_url" class="spark-nav-profile-photo m-r-xs" style="border: none !important; padding: unset !important">
