<create-team inline-template :user="user">
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="position: relative;">
            ...
            <div class="loader" v-if="loading"
                 style="position:absolute; left: 0; top: 0; height: 100%; width: 100%; display: flex; align-items: center; justify-content: center; background: rgb(255,255,255); z-index: 1000">
                <i class="fa fa-btn fa-spinner fa-spin" style="font-size: 35px"></i>
            </div>
                ...
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-6">
                        <button type="submit" class="btn btn-primary"
                                ...
                                :disabled="form.busy">
                            <span v-if="form.busy">
                                <i class="fa fa-spinner"></i> Creating
                            </span>
                            <span v-else>
                                Create
                            </span>
